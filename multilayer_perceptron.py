...
def Build():
    ...
    x = Dense(200,kernel_initializer='random_uniform', activation=act)(inputs)
    x = Dense(200,kernel_initializer='random_uniform', activation=act)(x)
    x = Dense(200,kernel_initializer='random_uniform', activation=act)(x)
    x = Dense(200,kernel_initializer='random_uniform', activation=act)(x)
    x = Dense(200,kernel_initializer='random_uniform', activation=act)(x)
    x = Dense(200,kernel_initializer='random_uniform', activation=act)(x)
    ...
    predictions = Dense(65536, kernel_initializer='random_uniform', activation='sigmoid')(x)
